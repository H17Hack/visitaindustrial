...
public class Usuario implements Serializable {
    ...
    /**
     * Access method for dato.
     *
     * @return the current value of dato
     */
    public Set<Dato> getDato() {
        return dato;
    }

    /**
     * Setter method for dato.
     *
     * @param aDato the new value for dato
     */
    public void setDato(Set<Dato> aDato) {
        dato = aDato;
    }
